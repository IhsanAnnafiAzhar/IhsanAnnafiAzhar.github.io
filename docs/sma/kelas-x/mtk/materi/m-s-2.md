---
title: Latihan Matriks 2
parent: Matriks
layout: quiz
nav_order: 1.1
description: >-
   Jawab setiap soal untuk menguji pengetahuan yang sudah kamu pelajari.
questions:
  - question: >-
      Tempat apaka ini?
      ...
      align-items: center;">
           ...
           <img src="/assets/images/small-image.jpg"
           alt="Perpustakaan" style="max-width:95%; display:block; margin-top:0.5rem;">
    ...
    options:
      ...
      - Parkiran
    correct: 0
    explanation: "Yak betul, ini perpustakaan."

  - question: $$\begin{pmatrix} a &b \\ c&d \end{pmatrix}$$
    options:
      - "Pilihan 1"
      - "Pilihan 2"
      - "Pilihan 3"
      - "Pilihan kita :v"
    correct: 3
    explanation: "Yang bener adalah pilihan kita, karena apa? ntah."
...
Kerjakan kuis ini untuk melatih pemahaman tentang keselamatan berkendara sebelum lanjut ke materi berikutnya.